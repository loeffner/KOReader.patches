...
-- List view
local LIST_DIR_FONT_NOMINAL = 20 -- Default: 20 -- Nominal font size for directories in list view
local LIST_DIR_FONT_MAX = 26     -- Default: 26 -- Nominal font size for directories in list view
local TITLE_FONT_NOMINAL = 20    -- Default: 20 -- Nominal font size for book titles in list view
local TITLE_FONT_MAX = 20        -- Default: 26 -- Maximum font size for book titles in list view
local TITLE_FONT_MIN = 20        -- Default: 20 -- Minimum font size for book titles in list view
...
-- Grid view
local GRID_DIR_FONT_NOMINAL = 18 -- Default: 22 -- Nominal (and maximum) font size for directory names in overlay in grid view
local GRID_DIR_FONT_MIN = 18     -- Default: 18 -- Minimum font size for directory names in overlay in grid view
...
local function patchCoverBrowser(plugin)
    ...
    ptutil.list_defaults.directory_font_nominal = LIST_DIR_FONT_NOMINAL
    ptutil.list_defaults.directory_font_max = LIST_DIR_FONT_MAX
    ...
    ptutil.grid_defaults.dir_font_nominal = GRID_DIR_FONT_NOMINAL
    ptutil.grid_defaults.dir_font_min = GRID_DIR_FONT_MIN
end
